...
def _get_test_cookies():
    ...
    try:
        ...
        if not cookies.get("a1"):
            _log.debug("No a1 cookie")
            return None
        return cookies
    except Exception as exc:
        _log.debug("Cookie acquisition failed: %s", exc)
        return None
...
class TestUserContent:
    ...
    def test_get_user_info(self, client: XhsClient):
        ...
        try:
            ...
            if exc.code == -1:
                pytest.skip("API rate-limited user info endpoint")
            raise
    ...
    def test_get_user_notes(self, client: XhsClient):
        ...
        try:
            ...
            if exc.code == -1:
                pytest.skip("API rate-limited user notes endpoint")
            raise
    ...
    def test_get_user_favorites(self, client: XhsClient):
        ...
        try:
            ...
            if exc.code == -1:
                pytest.skip("API rate-limited user favorites endpoint")
            raise
...
class TestNotifications:
    ...
    def test_notification_mentions(self, client: XhsClient):
        ...
        try:
            ...
            if exc.code == -1:
                pytest.skip("API rate-limited notification mentions endpoint")
            raise
    ...
    def test_notification_likes(self, client: XhsClient):
        ...
        try:
            ...
            if exc.code == -1:
                pytest.skip("API rate-limited notification likes endpoint")
            raise
    ...
    def test_notification_connections(self, client: XhsClient):
        ...
        try:
            ...
            if exc.code == -1:
                pytest.skip("API rate-limited notification connections endpoint")
            raise
